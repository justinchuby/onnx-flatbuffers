...
class GraphProto(object):
    ...
    def SparseInitializer(self, j):
        ...
        if o != 0:
            ...
            x += flatbuffers.number_types.UOffsetTFlags.py_type(j) * 4
            x = self._tab.Indirect(x)
            from onnxfbs.protos.SparseTensorProto import SparseTensorProto
    ...
    def Input(self, j):
        ...
        if o != 0:
            ...
            x += flatbuffers.number_types.UOffsetTFlags.py_type(j) * 4
            x = self._tab.Indirect(x)
            from onnxfbs.protos.ValueInfoProto import ValueInfoProto
            obj = ValueInfoProto()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
    ...
    def QuantizationAnnotation(self, j):
        ...
        if o != 0:
            ...
            x += flatbuffers.number_types.UOffsetTFlags.py_type(j) * 4
            x = self._tab.Indirect(x)
            from onnxfbs.protos.TensorAnnotation import TensorAnnotation
